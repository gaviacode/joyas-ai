...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: "/en/guides/types-of-pearls-1", destination: "/en/guides/types-of-pearls", permanent: true },
      { source: "/pt-br/guias/ouro-branco-3", destination: "/pt-br/guias/ouro-branco", permanent: true },
      { source: "/pt-br/guias/ouro-rose-1", destination: "/pt-br/guias/ouro-rose", permanent: true },
      {
        source: "/guias/como-saber-si-una-joya-es-de-oro-1",
        destination: "/guias/como-saber-si-una-joya-es-de-oro",
        permanent: true,
      },
      { source: "/guias/platino-3", destination: "/guias/platino", permanent: true },
      { source: "/en/guides/925-sterling-silver-5", destination: "/en/guides/925-sterling-silver", permanent: true },
      {
        source: "/en/guides/how-to-care-for-jewelry-1",
        destination: "/en/guides/how-to-care-for-jewelry",
        permanent: true,
      },
      {
        source: "/en/guides/how-to-choose-earrings-1",
        destination: "/en/guides/how-to-choose-earrings",
        permanent: true,
      },
      { source: "/en/guides/rose-gold-3", destination: "/en/guides/rose-gold", permanent: true },
      {
        source: "/en/guides/types-of-earring-backs-1",
        destination: "/en/guides/types-of-earring-backs",
        permanent: true,
      },
